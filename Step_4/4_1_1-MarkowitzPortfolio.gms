...
ExpectedTotalReturns(i) = exp(sum(t, log(1 + Returns(i,t)))); // Adjusted
...
EQUATIONS
    ...
    VarCon       'Equation defining the maximum variance constraint'
...
VarCon ..      sqrt(PortVariance)  =l= SydInvestStd;

ObjDef    ..   z =e= (1-lambda) * PortReturn - lambda * PortVariance;

MODEL MaxReturnModel 'model 4-1-1' /ReturnDef, VarDef, NormalCon, VarCon, ObjDef/;

lambda = 0;

// with lambda = 0, we essentially have z = PortReturn

SOLVE MaxReturnModel MAXIMIZING z USING nlp;
